...
<!-- Meta tags -->
	...
	<title><?php echo $SYSINFO['sys_title_cn'];?>-<?php echo $SYSTEM_TITLE;?></title>
	<meta name="keywords" content="<?php echo $SYSINFO['sys_keywords_cn'];?>">
	<meta name="description" content="<?php echo $SYSINFO['sys_description_cn'];?>-<?php echo $SYSTEM_TITLE;?>">
...
<body>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2500">
		   ...
		   <?php if($flashlight_list){?>
			...
			<div class="item active">
				<a href="<?php echo $v[asd_link];?>" class="slider" target="_blank"><img class="img-responsive" src="<?php echo $v[asd_imgurl];?>" alt="<?php echo $v[asd_name_cn];?>" style="max-height:800px;"></a>
			</div>
			<?php }else{ ?>
			<div class="item">
				<a href="<?php echo $v[asd_link];?>" class="slider" target="_blank"><img class="img-responsive" src="<?php echo $v[asd_imgurl];?>" alt="<?php echo $v[asd_name_cn];?>" style="max-height:800px;"></a>
	...
	<div class="service-section w100-l fixed-padding" id="iswd">
		<div class="container">
		<div class="row">
			<div><p class="wangdian"><span class="wangdianx"><img src="images/wangd.png">网点</span></p></div>
			<?php if($partner_list){?>
			...
			<div style="float:right;padding-bottom: 30px;">
				<a href="<?php echo URL_NAV('partner');?>" class="lookmoveorange">查看更多</a>
			</div><!-- ./text-center -->
		</div><!-- /.row -->
		</div><!-- /.container -->
	</div><!-- /.service-section -->
	...
	<div class="about-us-section w100-l">
		...
		<div class="col-lg-7 col-md-7 col-sm-12 for-this index_blog_one">
			...
			<div style="float:right;padding-top: 30px;">
				<a href="<?php echo URL_NAV('about');?>" class="lookmovewhite">查看更多</a>
			</div>
		</div><!-- /.col-lg-5 -->
	...
	<div class="blog-post-section w100-l fixed-padding">
		<div class="container">
		<div class="row">
			<div><p class="wangdian"><span class="wangdianx"><img src="images/zhixun.png">资讯</span></p></div>
			<?php if($news_list){?>
				<?php foreach($news_list as $k => $v){?>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 w100">
				<a href="<?php echo URL_NEWS('news',$v[cat_id],$v[article_id]);?>" title="<?php echo $v['title_cn'];?>" class="white-color w100-l zhixun">
					<img src="<?php echo $v['imgurl'];?>" alt="<?php echo $v['title_cn'];?>" style="max-height:160px;"/>
					<div class="detail-box">
						<img src="images/right.png"><span><?php echo $v['title_cn'];?></span>
					</div><!-- /.detail-box -->
				</a><!-- /.white-color -->
			</div><!-- /.col-lg-4 -->
				<?php } ?>
			<?php } ?>
			<div class="lookm">
				<a href="<?php echo URL_NAV('news');?>" class="lookmoveorange">了解更多</a>
			</div><!--/.text-center -->
		</div><!-- /.row -->
		</div><!-- /.container -->
