            	...
            	<div class="general_content">
					...
					td span {color:red;}
						...
						<div class="alert alert-info">
							<a href="<?php echo URL_NAV(CUTURL('power_'.$r[2]));?>">文章列表</a>
							<a> - </a>
							<a>添加文章</a>
						</div>
							...
							<input type="hidden" name="act" value="add">
								...
								<tr>
									<td>网页关键字英文：</td>
									<td><input class="small-text" type="text" name="keyword" value="<?php echo $row['keyword']; ?>" style="width:300px;" /> （多个请用，隔开）</td>
								</tr>
								<tr>
									<td>网页关键字中文：</td>
									<td><input class="small-text" type="text" name="keyword_cn" value="<?php echo $row['keyword_cn']; ?>" style="width:300px;" />（多个请用，隔开） </td>
								</tr>
								<tr>
									<td valign="top">文章内容(英文)：</td>
								...
								<tr><td colspan="2"><span class="button-container"><input class="btn btn-small btn-primary" type="submit" name="submit" value="添加" /></span></td></tr>
							</table>
							</form>
