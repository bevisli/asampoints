...
<?php if($result['countpage']>0){?>
	<li><a class="upPage"  href="<?php echo $baseUrl.$_SERVER_PHP_SELF.$result['preurl'];?>">上一页</a></li>
		<?php if($first_page==1){?>
		...
		<?php }?>
	<li><a class="nextPage" href="<?php echo $baseUrl.$_SERVER_PHP_SELF.$result['nexturl'];?>" >下一页</a></li>
<?php }?>
</ul>