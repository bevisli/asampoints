<?php if(!defined('HUISHI_SOFT_IN')) exit('Access Denied'); ?><div class="row-fluid">
  <div id="footer" class="span12" style="color:#fff;">Copyright &copy; 2016. FRIEITEX. All rights reserved </div>
</div>
