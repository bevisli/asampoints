            	...
            	<div class="general_content">
					...
					td span {color:red;}
						...
						<div class="alert alert-info">
							...
							<input type="hidden" name="thislistid" id="thislistid" value="<?php echo $row['pro_id']; ?>" />
							<table class="table table-striped table-bordered bootstrap-datatable">
							<input type="hidden" name="act" value="edit">
								<tr width="80px">
									<td>状态：</td>
									<td><select name="is_show" data-rel="chosen">
										<option value="1" <?php if($row['is_show']==1){ echo "selected"; }?>>显示</option>
										<option value="2" <?php if($row['is_show']==2){ echo "selected"; }?>>隐藏</option>
									</select></td>
								</tr>
								<tr>
									<td>产品分类：</td>
									<td><select name="cat_id" id="cat_id" data-rel="chosen">
										...
										foreach($cat_list as $k=>$v) { ?>
											<option value="<?php echo $v[cat_id];?>" <?php if($row['cat_id']==$v['cat_id']){?>selected<?php } ?>><?php echo $v[keyword];?><?php echo $v[cat_name];?></option>
										<?php }
											}
										?>
									</select></td>
								...
								<tr>
									<td>产品名英文：</td>
									<td><input class="small-text" type="text" name="title" value="<?php echo $row['title']; ?>" style="width:200px;" /> </td>
								</tr>
								<tr>
									<td>产品名中文：</td>
									<td><input class="small-text" type="text" name="title_cn" value="<?php echo $row['title_cn']; ?>" style="width:200px;" /> </td>
								</tr>
								<tr>
									<td>产品图片1：</td>
									<td><input type="file" name="imgurl[]"  style="width:250px;" maxlength="200" />（建议产品图片尺寸：800x533）
									<?php if($row['thumb']){?>
									<br /><a href="<?php echo $row['thumb'];?>" target="_blank"><img src="<?php echo $row['thumb'];?>" height="150"></a>
									<?php } ?></td>
								</tr>
								<tr>
									<td>产品图片2：</td>
									<td><input type="file" name="imgurl1[]"  style="width:250px;" maxlength="200" />（建议产品图片尺寸：800x533）
									<?php if($row['thumb1']){?>
									<br /><a href="<?php echo $row['thumb1'];?>" target="_blank"><img src="<?php echo $row['thumb1'];?>" height="150"></a>
									<?php } ?></td>
								</tr>
								<tr>
									<td>产品图片3：</td>
									<td><input type="file" name="imgurl2[]"  style="width:250px;" maxlength="200" />（建议产品图片尺寸：800x533）
									<?php if($row['thumb2']){?>
									<br /><a href="<?php echo $row['thumb2'];?>" target="_blank"><img src="<?php echo $row['thumb2'];?>" height="150"></a>
									<?php } ?></td>
								</tr>
								<tr>
									<td>产品图片4：</td>
									<td><input type="file" name="imgurl3[]"  style="width:250px;" maxlength="200" />（建议产品图片尺寸：800x533）
									<?php if($row['thumb3']){?>
									<br /><a href="<?php echo $row['thumb3'];?>" target="_blank"><img src="<?php echo $row['thumb3'];?>" height="150"></a>
									<?php } ?></td>
								</tr>
								<tr>
									<td>产品图片5：</td>
									<td><input type="file" name="imgurl4[]"  style="width:250px;" maxlength="200" />（建议产品图片尺寸：800x533）
									<?php if($row['thumb4']){?>
									<br /><a href="<?php echo $row['thumb4'];?>" target="_blank"><img src="<?php echo $row['thumb4'];?>" height="150"></a>
									<?php } ?>
									</td>
								</tr>
								<tr>
								...
								<tr><td colspan="2"><span class="button-container"><input class="btn btn-small btn-primary" type="submit" name="submit" value="修改产品" /></span></td></tr>
							</table>
							</form>
