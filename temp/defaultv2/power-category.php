            	...
            	<div class="general_content">
					...
					td span {color:red;}
						...
						<div class="alert alert-info">
							<a href="<?php echo URL_NAV(CUTURL('power_category'));?>">网点</a>
							<a href="<?php echo URL_NAV('power_category-add');?>" style="float:right;">新增网点</a>
						</div>
		...
		<table class="table table-striped table-bordered bootstrap-datatable">
			...
			<tr style="text-align:center">
				...
				<td>
					...
					<a class="btn btn-small btn-danger" href="<?php echo URL_NAV('power_'.$r[2].'-del_'.$value[cat_id]);?>" onclick="return confirm('确定删除该网点！');">删除</a>
				</td>
			</tr>
			<?php }?>
			<?php } else { ?>
